...
public class RoboSoccerRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRootref1=new Firebase("https://vibhav-4b5b9.firebaseio.com/RoboSoccer");
            ...
            public void onClick(View view) {
                if (InternetConnection.checkConnection(getApplicationContext())){
                    ...
                    if(TeamName.isEmpty()==true||name1.isEmpty()==true||Rollno1.isEmpty()==true||Phoneno1.isEmpty()==true||isPhonenovalid(Phoneno1)==false)
                    {
                        ...
                        Toast.makeText(RoboSoccerRegistration.this, "Registration done For RoboSoccer ",
                                Toast.LENGTH_LONG).show();
                        startActivity(new Intent(RoboSoccerRegistration.this, MainActivity.class));
                    }

                }
                else
                {
                    Toast.makeText(RoboSoccerRegistration.this,R.string.string_internet_connection_not_available,
                            Toast.LENGTH_LONG).show();}}
        });
    }
