...
public class MiniMilitiaRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_treasure_registration);
        ...
        mRootref1=new Firebase("https://vibhav-4b5b9.firebaseio.com/MiniMilitia");
        ...
        massBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (InternetConnection.checkConnection(getApplicationContext())){
                    ...
                    if(TeamName.isEmpty()==true||name1.isEmpty()==true||Rollno1.isEmpty()==true||Phoneno1.isEmpty()==true||name2.isEmpty()==true||name3.isEmpty()==true||Rollno2.isEmpty()==true||Rollno3.isEmpty()||Phoneno3.isEmpty()==true||Phoneno2.isEmpty()==true||isPhonenovalid(Phoneno1)==false||isPhonenovalid(Phoneno2)==false||isPhonenovalid(Phoneno3)==false)
                    {
                        ...
                        Toast.makeText(MiniMilitiaRegistration.this, "Registration done For MiniMilitia",
                                Toast.LENGTH_LONG).show();
                        startActivity(new Intent(MiniMilitiaRegistration.this, MainActivity.class));
                    }

                }
                else
                {
                    Toast.makeText(MiniMilitiaRegistration.this,R.string.string_internet_connection_not_available,
                            Toast.LENGTH_LONG).show();}}
        });
    }
