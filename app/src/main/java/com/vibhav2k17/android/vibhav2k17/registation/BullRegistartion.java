...
public class BullRegistartion extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_bull);

        Firebase.setAndroidContext(this);

        mRootref=new Firebase("https://vibhav-4b5b9.firebaseio.com/BullStock");
        ...
        massBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (InternetConnection.checkConnection(getApplicationContext())){
                    ...
                    Firebase childRef=mRootref.child(Phoneno);
                    ...
                    if(name.isEmpty()==true||Rollno.isEmpty()==true||Phoneno.isEmpty()==true||email.isEmpty()==true||isEmailValid(email)==false||isPhonenovalid(Phoneno)==false)
                    {
                        ...
                        Toast.makeText(BullRegistartion.this, "Registration done For Bull Stock",
                                Toast.LENGTH_LONG).show();
                        startActivity(new Intent(BullRegistartion.this, MainActivity.class));
                    }

                }
                else
                {
                    Toast.makeText(BullRegistartion.this,R.string.string_internet_connection_not_available,
                            Toast.LENGTH_LONG).show();}}
        });
