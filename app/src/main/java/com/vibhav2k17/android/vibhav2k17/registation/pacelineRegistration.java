...
public class pacelineRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRootref1=new Firebase("https://vibhav-4b5b9.firebaseio.com/PacelineFollower");
            ...
            public void onClick(View view) {
                if (InternetConnection.checkConnection(getApplicationContext())){
                    ...
                    if(TeamName.isEmpty()==true||name1.isEmpty()==true||Rollno1.isEmpty()==true||Phoneno1.isEmpty()==true||isPhonenovalid(Phoneno1)==false)
                    {
                        ...
                        Toast.makeText(pacelineRegistration.this, "Registration done For Paceline follower ",
                                Toast.LENGTH_LONG).show();
                        startActivity(new Intent(pacelineRegistration.this, MainActivity.class));
                    }

                }
                else
                {
                    Toast.makeText(pacelineRegistration.this,R.string.string_internet_connection_not_available,
                            Toast.LENGTH_LONG).show();}}
        });
    }
