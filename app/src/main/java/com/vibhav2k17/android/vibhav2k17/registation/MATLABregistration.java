...
public class MATLABregistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRootref=new Firebase("https://vibhav-4b5b9.firebaseio.com/Matlab");
            ...
            public void onClick(View view) {
                if (InternetConnection.checkConnection(getApplicationContext())){
                    ...
                    if(name.isEmpty()==true||Rollno.isEmpty()==true||Phoneno.isEmpty()==true||email.isEmpty()==true||isEmailValid(email)==false||isPhonenovalid(Phoneno)==false)
                    {
                        ...
                        Toast.makeText(MATLABregistration.this, "Registration done For Matlab",
                                Toast.LENGTH_LONG).show();
                        startActivity(new Intent(MATLABregistration.this, MainActivity.class));
                    }

                }
                else
                {
                    Toast.makeText(MATLABregistration.this,R.string.string_internet_connection_not_available,
                            Toast.LENGTH_LONG).show();}}
        });
