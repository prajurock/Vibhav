...
public class TreasureRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRootref1=new Firebase("https://vibhav-4b5b9.firebaseio.com/TreasureHunt");
                        ...
                        public void onClick(View view) {
                            if (InternetConnection.checkConnection(getApplicationContext())){
                                ...
                                if(TeamName.isEmpty()==true||name1.isEmpty()==true||Rollno1.isEmpty()==true||Phoneno1.isEmpty()==true||name2.isEmpty()==true||name3.isEmpty()==true||Rollno2.isEmpty()==true||Rollno3.isEmpty()||Phoneno3.isEmpty()==true||Phoneno2.isEmpty()==true||isPhonenovalid(Phoneno1)==false||isPhonenovalid(Phoneno2)==false||isPhonenovalid(Phoneno3)==false)
                                {
                                    ...
                                    Toast.makeText(TreasureRegistration.this, "Registration done For Treasure Hunt",
                                            Toast.LENGTH_LONG).show();
                                    startActivity(new Intent(TreasureRegistration.this, MainActivity.class));
                                }

                            }
                            else
                            {
                                Toast.makeText(TreasureRegistration.this,R.string.string_internet_connection_not_available,
                                        Toast.LENGTH_LONG).show();}}
                    });
                }
