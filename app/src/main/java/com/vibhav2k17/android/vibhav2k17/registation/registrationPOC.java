...
public class registrationPOC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_poc);
        ...
        mRootref1=new Firebase("https://vibhav-4b5b9.firebaseio.com/PiratesOfCircuit");
        ...
        massBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (InternetConnection.checkConnection(getApplicationContext())){
                    ...
                    if(TeamName.isEmpty()==true||name1.isEmpty()==true||Rollno1.isEmpty()==true||Phoneno1.isEmpty()==true||name2.isEmpty()==true||Rollno2.isEmpty()==true||Phoneno2.isEmpty()==true||isPhonenovalid(Phoneno1)==false||isPhonenovalid(Phoneno2)==false)
                    {
                        ...
                        Toast.makeText(registrationPOC.this, "Registration done For Pirates of Circuit",
                                Toast.LENGTH_LONG).show();
                        startActivity(new Intent(registrationPOC.this, MainActivity.class));
                    }

                }
                else
                {
                    Toast.makeText(registrationPOC.this,R.string.string_internet_connection_not_available,
                            Toast.LENGTH_LONG).show();}}
        });
    }
