...
public class CSgo extends AppCompatActivity {
    ...
    private EditText mValueField16;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mValueField14= (EditText) findViewById(R.id.valueField6);
        mValueField15= (EditText) findViewById(R.id.rollnodata5);
        mValueField16= (EditText) findViewById(R.id.phoneno6data);


        mRootref1=new Firebase("https://vibhav-4b5b9.firebaseio.com/CSgo");
        ...
        massBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (InternetConnection.checkConnection(getApplicationContext())){
                    ...
                    String name5=mValueField14.getText().toString();
                    String Rollno5=mValueField15.getText().toString();
                    String Phoneno5=mValueField16.getText().toString();
                    ...
                    if (TextUtils.isEmpty(name5)) {
                        mValueField14.setError(getString(R.string.error_field_required));
                        focusView = mValueField14;
                        cancel = true;
                    }
                    if (TextUtils.isEmpty(Rollno5)) {
                        mValueField15.setError(getString(R.string.error_field_required));
                        focusView = mValueField15;
                        cancel = true;
                    }
                    if (TextUtils.isEmpty(Phoneno5)) {
                        mValueField16.setError(getString(R.string.error_field_required));
                        focusView = mValueField16;
                        cancel = true;
                    }else if (!isPhonenovalid(Phoneno5)){
                        mValueField16.setError(getString(R.string.Invalid_no));
                        focusView=mValueField16;
                        cancel=true;
                    }
                    ...
                    if(TeamName.isEmpty()==true||name1.isEmpty()==true||Rollno1.isEmpty()==true||Phoneno1.isEmpty()==true||name2.isEmpty()==true||Rollno2.isEmpty()==true||Phoneno2.isEmpty()==true||name3.isEmpty()==true||Rollno3.isEmpty()==true||Phoneno3.isEmpty()==true||name4.isEmpty()==true||Rollno4.isEmpty()==true||Phoneno4.isEmpty()==true||name5.isEmpty()==true||Rollno5.isEmpty()==true||Phoneno5.isEmpty()==true||isPhonenovalid(Phoneno1)==false||isPhonenovalid(Phoneno2)==false||isPhonenovalid(Phoneno3)==false||isPhonenovalid(Phoneno4)==false||isPhonenovalid(Phoneno5)==false)
                    {
                        ...
                        childRef.child("Name5").setValue(name5);
                        childRef.child("Roll no5").setValue(Rollno5);
                        childRef.child("Phone no5").setValue(Phoneno5);



                        Toast.makeText(CSgo.this, "Registration done For CSGO",
                                Toast.LENGTH_LONG).show();
                        startActivity(new Intent(CSgo.this, MainActivity.class));
                    }

                }
                else
                {
                    Toast.makeText(CSgo.this,R.string.string_internet_connection_not_available,
                            Toast.LENGTH_LONG).show();}}
        });
    }
