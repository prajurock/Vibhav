...
public class VintricityRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vintricity_registration);
        ...
        mRootref1=new Firebase("https://vibhav-4b5b9.firebaseio.com/Vitricity");
        ...
        massBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (InternetConnection.checkConnection(getApplicationContext())){
                    ...
                    if(TeamName.isEmpty()==true||name1.isEmpty()==true||Rollno1.isEmpty()==true||Phoneno1.isEmpty()==true||isPhonenovalid(Phoneno1)==false||isPhonenovalid(Phoneno1)==false)
                    {
                        ...
                        Toast.makeText(VintricityRegistration.this, "Registration done For Vitricity",
                                Toast.LENGTH_LONG).show();
                        startActivity(new Intent(VintricityRegistration.this, MainActivity.class));
                    }

                }
                else
                {
                    Toast.makeText(VintricityRegistration.this,R.string.string_internet_connection_not_available,
                            Toast.LENGTH_LONG).show();}}
        });
    }
